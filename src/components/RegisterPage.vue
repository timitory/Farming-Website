            ...
            <form @submit.prevent="Register">
                ...
                <div class="mb-4">
                    <div class="relative">
                        ...
                        <input type="password" v-model="RepeatPassword" class="block w-full rounded-lg pl-10 py-3 text-sm text-gray-800 border border-gray-300 focus:outline-none focus:border-blue-500" placeholder="Repeat Password">
                    </div>
                    <div class="text-red-500 text-left text-sm" v-if="errors.RepeatPassword">
...
export default{
    ...
    methods:{
        Register(){
            let Validations= new SignUpValidation(this.email,this.password,this.Firstname,this.RepeatPassword,this.Lastname);
            let datas=['email','password','RepeatPassword','Firstname','Lastname']
            this.errors=Validations.CheckValidations();
            if(datas in this.errors){
                return false
            }
        }
    },
